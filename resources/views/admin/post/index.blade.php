            ...
            <form action="{{ route('admin#createPost') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postTitle" id="" class="form-control @error('postTitle')
                        is-invalid
                    @enderror" placeholder="Ender Post Title" value="{{ old('postTitle') }}">
                    @error('postTitle')
                    ...
                    <textarea class="form-control @error('description')
                        is-invalid
                    @enderror" cols="30" rows="5" name="description" placeholder="Ender Description" >{{ old('description') }}</textarea>
                    @error('description')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
